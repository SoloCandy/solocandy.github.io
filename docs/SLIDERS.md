...
| Rebound ζ | 10–200% | Rebound damping ratio, both axles | None — magnitude/feel |
...
| Settle Target | 0.10–1.50s | Target settle time; back-solves rebound ζ (clamped 10–100%; markers at 0.35/0.60/0.90/1.30s = PLANTED/RACE/SPORT/ROAD, softer still is SOFT) | None directly |
